...
// STEP 11
// How do arrow functions affect constructor functions? we cant use fat aroow functions as constructor functions if we do an error will apear in the console.
...
// 1. What is "this" when joe.scope() is invoked? this in constructor functions is a instance property of the object. 
//
// 2. What is "this" when joe.scopeArrow() is invoked? this will be the same value of the function when the function was called
//
// 3. Explain why "this" is different when an arrow function is used.
// arrow functions do not have their own 'this' it's value remains the same as the function's value unlike constructor functions this is an instance property of an object. 
